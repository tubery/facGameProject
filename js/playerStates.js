...
export class IdleRight extends State {
	...
	handleInput(input) {
		if (input === "PRESS right") {
			...
			this.game.player.setState(states.JUMP_RIGHT);
		} else if (input === "PRESS space") {
			this.game.player.setState(states.ATTACK_RIGHT);
		}
	}
}
export class IdleLeft extends State {
	...
	handleInput(input) {
		if (input === "PRESS right") {
			...
			this.game.player.setState(states.JUMP_LEFT);
		} else if (input === "PRESS space") {
			this.game.player.setState(states.ATTACK_LEFT);
		}
	}
}
...
export class JumpRight extends State {
	...
	handleInput(input) {
		...
		if (this.game.player.vy > 0) {
			this.game.player.setState(states.FALL_RIGHT);
		} else if (input === "PRESS left") {
			this.game.player.setState(states.JUMP_LEFT);
		} else if (input === "PRESS space") {
			this.game.player.setState(states.ATTACK_RIGHT_3);
		}
	}
}
export class JumpLeft extends State {
	...
	handleInput(input) {
		if (this.game.player.vy > 0) {
			this.game.player.setState(states.FALL_LEFT);
		} else if (input === "PRESS right") {
			this.game.player.setState(states.JUMP_RIGHT);
		} else if (input === "PRESS space") {
			this.game.player.setState(states.ATTACK_LEFT_3);
		}
	}
}
	...
	handleInput(input) {
		if (this.game.player.frameX === this.game.player.maxFrame) {
			if (input === "PRESS space") {
				this.game.player.setState(states.ATTACK_RIGHT_2);
			} else {
				this.game.player.setState(states.IDLE_RIGHT);
			}
		}
...
export class AttackLeft extends State {
	...
	handleInput(input) {
		if (this.game.player.frameX === this.game.player.maxFrame) {
			if (input === "PRESS space") {
				this.game.player.setState(states.ATTACK_LEFT_2);
			} else {
				this.game.player.setState(states.IDLE_LEFT);
			}
		}
